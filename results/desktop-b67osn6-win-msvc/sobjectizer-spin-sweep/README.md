...
|---|---:|---|
| `<shape>-profile-10s.json` | unset | the adapter's profile, 10 s — the published `2c-spin` configuration, measured first (ping-pong 827 [770, 895] ns) |
...
| `<shape>-profile-10s-b.json` | unset | the profile again, last (ping-pong 821 [721, 947] ns): the drift control |
